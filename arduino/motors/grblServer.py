...
def version():
    ...
    print("[+-][0-9]+ [+-][0-9]+ [+-][0-9]+ (e.g. +82 -56 +3) performs a relative movement w.r.t. the current position")
    print("[0-9]+ [0-9]+ [0-9]+   (e.g. 180 290 12) moves to the given coordinates")
    ...
    print("status                 returns the current status")
    print("settings               returns the current settings")
    print("quit                   exit")
    exit(0)
...
try:
    ...
    if (not args.demo):
        arduino = serial.Serial(args.usb, 115200)
    else:
        arduino = 'DEMO'
except:
...
# initialize
Gcommand('$N1=F600', arduino)   #default rate
Gcommand('$X', arduino)         #unlock
Gcommand('$10=0', arduino)      #report WPos intead of MPos

# current settings in CNC board (02/12/2020)
#Gcommand('$1=25', arduino) 
#Gcommand('$2=0', arduino) 
#Gcommand('$3=5', arduino) 
#Gcommand('$4=0', arduino) 
#Gcommand('$5=0', arduino) 
#Gcommand('$6=0', arduino) 
#Gcommand('$10=1', arduino) 
#Gcommand('$11=0.010', arduino) 
#Gcommand('$12=0.002', arduino) 
#Gcommand('$13=0', arduino) 
#Gcommand('$20=0', arduino) 
#Gcommand('$21=1', arduino) 
#Gcommand('$22=1', arduino) 
#Gcommand('$23=7', arduino) 
#Gcommand('$24=25.000', arduino) 
#Gcommand('$25=500.000', arduino) 
#Gcommand('$26=250', arduino) 
#Gcommand('$27=1.000', arduino) 
#Gcommand('$30=1000', arduino) 
#Gcommand('$31=0', arduino) 
#Gcommand('$32=0', arduino) 
#Gcommand('$100=800.000', arduino) 
#Gcommand('$101=800.000', arduino) 
#Gcommand('$102=800.000', arduino) 
#Gcommand('$110=1000.000', arduino) 
#Gcommand('$111=1000.000', arduino) 
#Gcommand('$112=800.000', arduino) 
#Gcommand('$120=30.000', arduino) 
#Gcommand('$121=30.000', arduino) 
#Gcommand('$122=30.000', arduino) 
#Gcommand('$130=200.000', arduino) 
#Gcommand('$131=200.000', arduino) 
#Gcommand('$132=200.000', arduino) 
...
#hardcoded limits for new array test bench
xmin = 0 
xmax = 295
ymin = 0
ymax = 175
...
while (True):
    ...
    xyz = client_data.split(" ")
    logging.debug("Received: %s" % client_data)

    absolute = re.match("[0-9]*\.?[0-9]+ [0-9]*\.?[0-9]+ [0-9]*\.?[0-9]+", client_data)
    ...
    if (absolute):
        ...
        if ((x >= xmin) and (x <= xmax) and (y >= ymin) and (y <= ymax) and (z >= zmin) and (z <= zmax)):
            ret = Gcommand("G90 G01 X%3.1f Y%3.1f Z%3.1f"%(x,y,z), arduino)
        else:
...
##            y = yold
    ...
    if re.match("home", client_data):
        Gcommand("$H", arduino)
        Gcommand("G92 x0 y0 z0", arduino) #set work coordinates to 0 0 0
        x = 0
        y = 0
        z = 0
        ret = "ok"
...
#        ret = 'Quit. Bye' 
    ...
    logging.info("Estimated position: (%3.1f,%3.1f,%3.1f)"%(x,y,z))
