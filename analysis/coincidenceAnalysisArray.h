...
#ifndef coincidenceAnalysisArray_h
#define coincidenceAnalysisArray_h
...
class coincidenceAnalysisArray {
public :
  ...
  int arrayId(int chId)
  {
   ...
   coincidenceAnalysisArray(TTree *tree=0);
   virtual ~coincidenceAnalysisArray();
...
#ifdef coincidenceAnalysisArray_cxx
coincidenceAnalysisArray::coincidenceAnalysisArray(TTree *tree) : fChain(0) 
{
...
coincidenceAnalysisArray::~coincidenceAnalysisArray()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t coincidenceAnalysisArray::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t coincidenceAnalysisArray::LoadTree(Long64_t entry)
{
...
void coincidenceAnalysisArray::Init(TTree *tree)
{
...
Bool_t coincidenceAnalysisArray::Notify()
{
...
void coincidenceAnalysisArray::Show(Long64_t entry)
{
...
Int_t coincidenceAnalysisArray::Cut(Long64_t entry)
{
...
#endif // #ifdef coincidenceAnalysisArray_cxx
